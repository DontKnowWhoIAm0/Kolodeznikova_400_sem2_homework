...
public interface WorkoutRequestService {
    ...
    void deleteWorkoutRequest(WorkoutRequest workoutRequest, boolean flag) throws SQLException;
    void addRespondentToRequest(WorkoutRequest workoutRequest, int respondentId) throws SQLException;
    void deleteRespondentFromRequest(WorkoutRequest workoutRequest, int respondentId, boolean flag) throws SQLException;
