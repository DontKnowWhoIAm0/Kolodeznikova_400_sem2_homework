...
public class WorkoutRequest {
    ...
    public WorkoutRequest(int id, int creatorId, List<Integer> respondentsId, Sports sport, String description, String city, LocalDate startDate, LocalDate endDate, boolean isTimeRelevant, LocalTime startTime, LocalTime endTime) {
        this.id = id;
    ...
    public WorkoutRequest(int creatorId, List<Integer> respondentsId, Sports sport, String description, String city, LocalDate startDate, LocalDate endDate, boolean isTimeRelevant, LocalTime startTime, LocalTime endTime) {
        this.creatorId = creatorId;
        this.respondentsId = respondentsId;
        this.sport = sport;
        this.description = description;
